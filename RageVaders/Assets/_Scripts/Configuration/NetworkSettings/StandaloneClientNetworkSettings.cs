...
{
	public class StandaloneClientNetworkSettings : IRVNetworkSettings
	{
		...
		public bool PublishServer { get; private set; } = false; // Used by IServerStarter in RVModulesRunner
		...
		public SetupType SetupType { get; } = SetupType.StandaloneClient;
	}
}
